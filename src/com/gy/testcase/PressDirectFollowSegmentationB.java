...
public class PressDirectFollowSegmentationB extends TestBase{
	@Test
	  public void pressDirectFollowSegmentationB() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("input.values.list")).sendKeys("5,6,7,8");
	    driver.findElement(By.id("dynamicRules_name")).clear();
	    driver.findElement(By.id("dynamicRules_name")).sendKeys("direct follow 压力测试B组");
	    driver.findElement(By.id("dynamicRules_note")).clear();
	    driver.findElement(By.id("dynamicRules_note")).sendKeys("direct follow 压力测试B组");
	   
	    driver.findElement(By.name("yt1")).click();
	    try {
	      AssertJUnit.assertEquals("direct follow 压力测试B组", driver.findElement(By.cssSelector("tr.odd > td")).getText());
	    } catch (Error e) {
