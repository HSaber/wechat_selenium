...
import com.hu.testcase.PollCreateTest;
import com.hu.testcase.StyleMethods;
...
public class PollCreate extends TestBase{
	boolean acceptNextAlert = true;
	
	public boolean flag = false;
	public static String Osname;
	 private static Logger logger = Logger.getLogger(PollCreate.class);

	@Test(groups="pollCreate",dependsOnGroups="waterMark")
	public void pollCreate() throws Exception {
