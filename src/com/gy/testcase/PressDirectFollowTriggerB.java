...
public class PressDirectFollowTriggerB extends TestBase{
	 @Test
	  public void pressDirectFollowTriggerB() throws Exception {
	    ...
	    driver.findElement(By.id("Triggers_category")).sendKeys("direct follow B组压力测试");
	    driver.findElement(By.id("Triggers_title")).clear();
	    driver.findElement(By.id("Triggers_title")).sendKeys("direct follow B组压力测试");
	    ...
	    new Select(driver.findElement(By.id("segmentation"))).selectByVisibleText("direct follow 压力测试B组");
	    ...
	    driver.findElement(By.xpath("(//textarea[@id='action_message'])[1]")).sendKeys("{{nickname}},direct follow B组压力测试");
	    ...
	    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys("direct follow B组压力测试"+ time);
	    Thread.sleep(1000);
	    ...
	    try {
	      AssertJUnit.assertEquals("direct follow B组压力测试", driver.findElement(By.xpath("//div[@id='triggers-grid']/div/table/tbody/tr/td[2]")).getText());
	    } catch (Error e) {
