...
public class TriggerSpecificQrCodeExNewConImmedia {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(TriggerSpecificQrCodeExNewConImmedia.class);
	...
	public void test() throws InterruptedException,Exception {
		...
		try{
		  ...
		  System.out.println("Open create trigger successfully!");
		    ...
		    String TriggerTitle="SpecQrExNewCon";
		    methods me=new methods();
		    me.triggerStr=TriggerTitle;
		    ...
		    new Select(driver.findElement(By.id("segmentation"))).selectByVisibleText("HC2+PersonalMenu");
            //actions
...
/*		    driver.findElement(By.id("delay_radio_1")).click();
		    ...
		    */
		    ...
		    driver.findElement(By.xpath("(//textarea[@id='action_message'])[3]")).sendKeys("{{nickname}}是已关注或者新关注的用户并且 属于HC2+PersonalMenu分组\n通过Scan Specific(QrcodePost) QrCode 触发"+TriggerTitle+".\n<a href=\"https://www.zhihu.com/question/31970604\">《死镜——B/B》</a>\n三秒前有一篇近期3的Post\n-----延时3s"+timeStr);
		    ...
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys("SpecQrExNewTri"+timeStr);
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys(Keys.ENTER);
