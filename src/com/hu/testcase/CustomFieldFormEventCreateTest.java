...
public class CustomFieldFormEventCreateTest {
	   WebDriver driver;
	  private String baseUrl;
	  private boolean acceptNextAlert = true;
	  private StringBuffer verificationErrors = new StringBuffer();
	  public String FieldTitle,CategoryTitle;
	  private static Logger logger = Logger.getLogger(CustomFieldFormEventCreateTest.class);
	...
	@Test(groups="CustomFEField", dependsOnGroups="CustomFieldFECategory")
	public void test() throws InterruptedException,Exception {		
	    ...
	    String[] CustomDFArr={"Names","Phone Number","FriendsAccount"+FieldTitle,"Comment"+FieldTitle};
