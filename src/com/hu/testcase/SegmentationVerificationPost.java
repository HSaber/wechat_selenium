...
public class SegmentationVerificationPost {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(SegmentationVerificationPost.class);
		@BeforeClass
		...
		try{
			...
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[1]"))).selectByVisibleText("Views");
			...
			+ "where a.wid="+methods.mid+" and a.type='read' and a.created_date>'"+SystemYesterday+"'";	
			...
			try{
				...
				logger.error("PostReadDate segmentation 查询人数不一致，mysql result:"+PostFollower+"  Segmentation result:"+summary_total);
				e.printStackTrace();
			}
			...
			try{
				...
				logger.error("PostReadDate segmentation 查询人数不一致，user_action_record Json result:"+PostJson+"  user_action_record_others result:"+PostOtherJson);
				e.printStackTrace();
			}
			...
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[1]/select"))).selectByVisibleText("Post");
			methods.Loading(driver, By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select"));
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[1]"))).selectByVisibleText("Read More");
			methods.Loading(driver, By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"));
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"))).selectByVisibleText("Date");
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[3]"))).selectByVisibleText("greater than");			
			driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/input")).sendKeys(SystemYesterday);			
			...
			+"RIGHT JOIN(SELECT openid from wechat_customer where mid ="+methods.mid+" and subscribe=1 ) b on a.openid=b.openid "
			+ "where a.wid="+methods.mid+" and a.type='readmore' and a.created_date>'"+SystemYesterday+"'";	
			System.out.println(sql);
			try {
					Connection conns =  MySQLConnection.devconn();
					PreparedStatement pst = conns.prepareStatement(sql);
			...
			try{
				...
				logger.error("PostReadMoreDate segmentation 查询人数不一致，mysql result:"+PostFollower+"  Segmentation result:"+summary_total);
				e.printStackTrace();
			}
	        ...
	        response = responsebuilder.setSource(queryStringObject.toString()).execute().actionGet();			
			hits = response.getHits();
			PostOtherJson=hits.getTotalHits()+"";
			System.out.println("user_action_record_post 查询的记录数="+hits.getTotalHits());
            ...
            response = responsebuilder.setSource(queryStringObject.toString()).execute().actionGet();			
			hits = response.getHits();
			PostJson=hits.getTotalHits()+"";
			System.out.println("user_action_record 查询的记录数="+hits.getTotalHits());
			try{
				AssertJUnit.assertEquals(PostJson, PostOtherJson);
			}catch(AssertionError e){
				logger.error("PostReadMoreDate segmentation 查询人数不一致，user_action_record Json result:"+PostJson+"  user_action_record_others result:"+PostOtherJson);
				e.printStackTrace();
			}
			//Post Share Date -------------------------------------------------------------------------------------------------
			driver.navigate().refresh();
			...
			responsebuilder =func.esConnect("wechat_customer");
	        queryString="{\"query\":{\"filtered\":{\"filter\":{\"bool\":{\"must\":[{\"term\":{\"mid\":"+methods.mid+"}},{\"term\":{\"subscribe\":\"1\"}},"
	        + "{\"has_child\":{\"type\":\"user_action_record_post\","
	        + "\"query\":{\"filtered\":{\"filter\":"
	        + "{\"bool\":{\"must\":[{\"term\":{\"wid\":"+methods.mid+"}},"
			...
			//Post link click Date -------------------------------------------------------------------------------------------------
			driver.navigate().refresh();
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[1]/select"))).selectByVisibleText("Post");
			methods.Loading(driver, By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select"));
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[1]"))).selectByVisibleText("Post Link");
			methods.Loading(driver, By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"));
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"))).selectByVisibleText("Date");
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[3]"))).selectByVisibleText("greater than");
			driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/input")).sendKeys(SystemYesterday);
			...
			sql="SELECT count(DISTINCT(a.openid)) as followerCount FROM `user_action_record` a "
			+"RIGHT JOIN(SELECT openid from wechat_customer where mid ="+methods.mid+" and subscribe=1 ) b on a.openid=b.openid "
			+ "where a.wid="+methods.mid+" and a.type='post_link_click' and a.created_date>'"+SystemYesterday+"'";	
			System.out.println(sql);
			try {
					Connection conns =  MySQLConnection.devconn();
					PreparedStatement pst = conns.prepareStatement(sql);
			...
			try{
				...
				logger.error("PostLinkClickDate Date segmentation 查询人数不一致，mysql result:"+PostFollower+"  Segmentation result:"+summary_total);
				e.printStackTrace();
			}
			...
			try{
				...
				logger.error("PostLinkClickDate segmentation 查询人数不一致，user_action_record Json result:"+PostJson+"  user_action_record_others result:"+PostOtherJson);
				e.printStackTrace();
			}
		...
		/*	//Qrcode Title -------------------------------------------------------------------------------------------------
			driver.navigate().refresh();
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[1]/select"))).selectByVisibleText("QR code");
			methods.Loading(driver, By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select"));
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"))).selectByVisibleText("QR Code Title");
			...
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[4]"))).selectByVisibleText("post blue letter");
			...
			System.out.println(summary+"   "+summary_total+"=================================================================");	
			 ...
			 sql="SELECT count(DISTINCT(a.openid)) as followerCount FROM `user_action_record` a "
			+"RIGHT JOIN(SELECT openid from wechat_customer where mid ="+methods.mid+" and subscribe=1 ) b on a.openid=b.openid "
			+ "where a.wid="+methods.mid+" and a.type='qrcode_scan' and a.keyword='post blue letter'";		
			 System.out.println(sql);
			try {
					Connection conns =  MySQLConnection.devconn();
					PreparedStatement pst = conns.prepareStatement(sql);
					...
					while (rs.next()) {
					  System.out.println(rs.getString("followerCount"));
					  QrcodeFollower=rs.getString("followerCount");
					  }	
					conns.close();
					pst.close();
					rs.close();
			...
			try{
				AssertJUnit.assertEquals(summary_total, QrcodeFollower);
			}catch(AssertionError e){
				logger.error("QrcodeTitle segmentation 查询人数不一致，mysql result:"+QrcodeFollower+"  Segmentation result:"+summary_total);
				e.printStackTrace();
			}
	        ...
	        + "\"query\":{\"filtered\":{\"filter\":"
	        + "{\"bool\":{\"must\":[{\"term\":{\"wid\":"+methods.mid+"}},"
	        + "{\"term\":{\"type\":\"qrcode_scan\"}},"
	        + "{\"term\":{\"keyword\":\"post blue letter\"}}]}}}}}}]}}}}}";
            System.out.println(queryString);
	        //Sample Query - JSONObject
	        //We convert the raw query string to JSONObject to avoid query parser error in Elasticsearch
	         queryStringObject = new JSONObject(queryString);
	        ...
	        //Elasticsearch Response
	         response = responsebuilder.setSource(queryStringObject.toString()).execute().actionGet();			
			 hits = response.getHits();
			 QrcodeOtherJson=hits.getTotalHits()+"";
			System.out.println("user_action_record_post 查询的记录数="+hits.getTotalHits());
            ...
            response = responsebuilder.setSource(queryStringObject.toString()).execute().actionGet();			
			hits = response.getHits();
			 QrcodeJson=hits.getTotalHits()+"";
			System.out.println("user_action_record 查询的记录数="+hits.getTotalHits());
			try{
				AssertJUnit.assertEquals(QrcodeJson, QrcodeOtherJson);
			}catch(AssertionError e){
				logger.error("QrcodeTitle segmentation 查询人数不一致，user_action_record Json result:"+QrcodeJson+"  user_action_record_others result:"+QrcodeOtherJson);
				e.printStackTrace();
			}
			*/
