...
public class TriggerAnyActionCondOnce {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(TriggerAnyActionCondOnce.class);
	@BeforeClass
	...
	public void test() throws InterruptedException,Exception {
		...
		try{
		  ...
		  System.out.println("Open create trigger successfully!");
		    ...
		    String TriggerTitle="AnyAct-ConOnce";
		    ...
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys("AnyActConOnce"+timeStr);
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys(Keys.ENTER);
