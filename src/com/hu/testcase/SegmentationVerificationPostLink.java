...
public class SegmentationVerificationPostLink {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(SegmentationVerificationPostLink.class);
		@BeforeClass
		...
		try{
			...
			logger.error("PostLinkClickDate segmentation 查询人数不一致，mysql result:"+PostFollower+"  Segmentation result:"+summary_total);
			e.printStackTrace();
		}
