...
public class TriggerAnyQrCodeNewConditionalDelay {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(TriggerAnyQrCodeNewConditionalDelay.class);
	...
	public void test() throws InterruptedException,Exception {
		...
		try{
		  ...
		  System.out.println("Open create trigger successfully!");
		    ...
		    String TriggerTitle="AnyQrNewCon";
...
/*		    driver.findElement(By.id("delay_radio_1")).click();
		    ...
		    driver.findElement(By.xpath("(//textarea[@id='action_message'])[2]")).sendKeys("{{nickname}} 新关注的用户\n通过  Scan Any QrCode 触发"+TriggerTitle+".\nAnd 你属于AB+Message分组\n间隔一秒之前有一张人物图片\n-----延时1s"+timeStr);
		    driver.findElement(By.id("delay_radio_1")).click();
		    ...
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys("AnyQrNewConTri"+timeStr);
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys(Keys.ENTER);
