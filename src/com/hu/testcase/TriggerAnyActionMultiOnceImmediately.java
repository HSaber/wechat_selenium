...
public class TriggerAnyActionMultiOnceImmediately {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(TriggerAnyActionMultiOnceImmediately.class);
	@BeforeClass
	...
	public void test() throws InterruptedException,Exception {
		...
		try{
		  ...
		  System.out.println("Open create trigger successfully!");
		    ...
		    String TriggerTitle="AnyActOnce";
		    ...
		    new Select(driver.findElement(By.id("action_post"))).selectByIndex(2);
		    ...
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys("AnyActOnceTri"+timeStr);
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys(Keys.ENTER);
