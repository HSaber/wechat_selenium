...
public class TriggerSpecificMenuOnceImmediately {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(TriggerSpecificMenuOnceImmediately.class);
	...
	public void test() throws InterruptedException,Exception {
		...
		try{
		  ...
		  System.out.println("Open create trigger successfully!");
		    ...
		    String TriggerTitle="SpeMenuOnce";
		    ...
		    driver.findElement(By.id("menu_click_scan")).click();
			  ...
			  while(true){
					 if(methods.isElementPresent(driver, By.className("msg_card")))
						 break;
				 }
		    ...
		    driver.findElement(By.xpath("(//textarea[@id='action_message'])[2]")).sendKeys("{{nickname}} Clicked Specific Menu.<a href=\"http://www.baidu.com\">百 度</a>\n-----延时3s\n---------    间隔三秒前收到一篇近期post\n--------下面是接了一张图片\n"+TriggerTitle+timeStr);
		    ...
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys("SpecMenuOnceTri"+timeStr);
		    driver.findElement(By.cssSelector("input.tagInputField.ui-autocomplete-input")).sendKeys(Keys.ENTER);
		    //save
