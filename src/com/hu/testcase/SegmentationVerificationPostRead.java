...
public class SegmentationVerificationPostRead {
	 WebDriver driver;
	 private static Logger logger = Logger.getLogger(SegmentationVerificationPostRead.class);
		@BeforeClass
		...
		try{
			...
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[1]"))).selectByVisibleText("Views");
			methods.Loading(driver, By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"));
			new Select(driver.findElement(By.xpath(".//*[@id='page']/div[2]/div[3]/div/div/div[2]/div[1]/div/div[2]/div/select[2]"))).selectByVisibleText("Post Name");
			...
			try{
				...
				logger.error("QrcodeTitle segmentation 查询人数不一致，mysql result:"+PostFollower+"  Segmentation result:"+summary_total);
				e.printStackTrace();
			}
			...
			try{
				...
				logger.error("QrcodeTitle segmentation 查询人数不一致，user_action_record Json result:"+PostJson+"  user_action_record_others result:"+PostOtherJson);
				e.printStackTrace();
			}
