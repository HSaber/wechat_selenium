...
public class CustomFieldFormEventCategory {
	  WebDriver driver;
	  private String baseUrl;
	  private boolean acceptNextAlert = true;
	  private StringBuffer verificationErrors = new StringBuffer();
	  public String CategoryTitle;
	  private static Logger logger = Logger.getLogger(CustomFieldFormEventCategory.class);
	...
	@Test(groups="CustomFieldFECategory")
	public void test() throws InterruptedException,Exception {				
	    ...
	    String[] CategoryArr={"FormEvent"+CategoryTitle};
